...
def standard_test():
    ...
    [_, k_evo_array] = BEC.interferometer_in_gravity(t, t_c, pulse_duration, wavelen, A, v, k_kick = k_kick, g_factor = g_factor, plot = True, gravity = 0.1) # Accurate g = 4.61*10**(-3) for 87Ru according to course notes
    moment = 2
